...
// void _restitchDress() { }
// void _repairDress() { }
const _kLeadingWidth = kToolbarHeight * 2;
...
class YodelAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _YodelAppBarState createState() => _YodelAppBarState();
}

class _YodelAppBarState extends State<YodelAppBar> {
...
class _YodelSliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  _YodelSliverAppBarDelegate({
  ...
  @override
  bool shouldRebuild(covariant _YodelSliverAppBarDelegate oldDelegate) {
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class YodelSliverAppBar extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const YodelSliverAppBar({
    Key key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  @override
  _YodelSliverAppBarState createState() => _YodelSliverAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _YodelSliverAppBarState extends State<YodelSliverAppBar>
  ...
  @override
  void didUpdateWidget(YodelSliverAppBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _YodelSliverAppBarDelegate(
